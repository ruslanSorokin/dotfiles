...
set -x tide_left_prompt_items vi_mode os yazi pwd git newline

set -x tide_yazi_bg_color $yellow
set -x tide_yazi_color black
...
# SSH
set -x tide_context_color_ssh black
set -x tide_context_bg_color $white
