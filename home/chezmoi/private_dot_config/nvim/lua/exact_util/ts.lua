...
---@return boolean
M.tree_has_injected_sql = function(parser)
  local has_injected_sql = false

  local injected_langs = parser:children()
  for lang, _ in pairs(injected_langs) do
    if lang == "sql" then
      has_injected_sql = true
    end
  end

  return has_injected_sql
end
